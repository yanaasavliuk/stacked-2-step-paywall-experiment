...
import HeroDiamond from '../assets/figma/illustration-diamond.png'
import HeroPlatinum from '../assets/figma/illustration-platinum.png'
import HeroGold from '../assets/figma/illustration-gold.png'
...
// Hero image per tier
const heroImages: Record<TierType, string> = {
  diamond: HeroDiamond,
  platinum: HeroPlatinum,
  gold: HeroGold,
}
const currentHeroImage = computed(() => heroImages[selectedTier.value])
...
/* Icon positions + fly-from-diamond offsets */
/* Each icon starts hidden behind the gem center (~50%, ~42%) and flies outward */
.hero-icon--1 { left: 5%;  top: 10%;  width: 13%; height: auto; --dx: 230%; --dy: 180%; }
.hero-icon--2 { left: 3%;  top: 44%;  width: 17%; height: auto; --dx: 190%; --dy: -15%; }
.hero-icon--3 { left: 80%; top: 8%;   width: 13%; height: auto; --dx: -180%; --dy: 190%; }
.hero-icon--4 { left: 76%; top: 44%;  width: 17%; height: auto; --dx: -150%; --dy: -15%; }
