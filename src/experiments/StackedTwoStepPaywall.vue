...
/* ═══════════════ DIAMOND ═══════════════ */
/* Chess.com motion tokens: ease-out-gentle (0,0,0.2,1) for scale/move, ease-out-strong (0,0,0.4,1) for fade/opacity */
...
.hero-anim--diamond .hero-sparkle--1 {
  ...
  animation: sparkle-img-pop 0.3s 0.35s cubic-bezier(0, 0, 0.4, 1) both;
}
.hero-anim--diamond .hero-sparkle--2 {
  left: 36%; top: 39%; width: 5%;
  animation: sparkle-img-pop 0.3s 0.55s cubic-bezier(0, 0, 0.4, 1) both;
}
...
.hero-anim--platinum .hero-sparkle--1 {
  ...
  animation: sparkle-img-pop 0.3s 0.3s cubic-bezier(0, 0, 0.4, 1) both;
}
.hero-anim--platinum .hero-sparkle--2 {
  left: 65%; top: 48%; width: 3.5%;
  animation: sparkle-img-pop 0.3s 0.5s cubic-bezier(0, 0, 0.4, 1) both;
}
...
.hero-anim--gold .hero-shadow--svg {
  ...
  opacity: 0;
  clip-path: none;
  animation: gold-shadow-appear 0.5s 0s cubic-bezier(0, 0, 0.4, 1) both;
}
.hero-anim--gold .hero-layer--icon {
  animation: icon-appear 0.5s 0s cubic-bezier(0, 0, 0.4, 1) both;
}
/* Gold 4 sparkles — ON the star surface, matching Figma */
.hero-anim--gold .hero-sparkle--1 { left: 34%; top: 14%; width: 10%; animation: sparkle-img-pop 0.3s 0.3s cubic-bezier(0, 0, 0.4, 1) both; }
.hero-anim--gold .hero-sparkle--2 { left: 57%; top: 10%; width: 8%;  animation: sparkle-img-pop 0.3s 0.45s cubic-bezier(0, 0, 0.4, 1) both; }
.hero-anim--gold .hero-sparkle--3 { left: 35%; top: 40%; width: 9%;  animation: sparkle-img-pop 0.3s 0.6s cubic-bezier(0, 0, 0.4, 1) both; }
.hero-anim--gold .hero-sparkle--4 { left: 49%; top: 15%; width: 18%; rotate: 90deg; animation: sparkle-img-pop 0.3s 0.75s cubic-bezier(0, 0, 0.4, 1) both; }
